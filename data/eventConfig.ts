...
export const BOSS_CONFIG = {
  ...
  'Hew Snake General [STR]':           { respawn:  7.5 * HOUR },
  'Jung Snake General [INT]':          { respawn:  7.5 * HOUR },
  'Ki Snake General [INT]':            { respawn:  7.5 * HOUR },
  ...
  'SoSo The Black Viper':              { respawn:  8.0 * HOUR },
  'SoSo The Black Viper [INT]':        { respawn:  8.0 * HOUR },
  'SoSo The Black Viper [STR]':        { respawn:  8.0 * HOUR },
  ...
  'Yul Snake General [STR]':           { respawn:  7.5 * HOUR },
